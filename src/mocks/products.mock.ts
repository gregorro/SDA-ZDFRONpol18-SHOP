...
export const productsMock: Product[] = [
    {
        ...
        quantity: 53,
        category: 'phones',
        description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse nec augue in leo lobortis efficitur. Suspendisse lorem risus, tristique feugiat.',
        photos: [
            {
                url: getRandomPhoto()
            }
